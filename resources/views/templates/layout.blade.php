...
<html lang="en">
	...
	<head>
		...
		<script src="{{ asset('assets/js/ajaxify.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('custom/jstree/jstree.bundle.js') }}" type="text/javascript"></script>
		<!--end::Page Scripts -->
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		<!-- begin:: Page -->
		<!-- begin:: Header Mobile -->
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " style="background-color: #f2f2f2;">
