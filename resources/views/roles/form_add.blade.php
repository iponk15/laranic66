...
@section('content')
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right form_add" action="{{ $url . '/store' }}" id="kt_form_1" method="post" onsubmit="return submitMe()">
            {{csrf_field()}}
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                <input type="text" class="form-control" name="role_name" placeholder="Enter role name" autocomplete="off">
