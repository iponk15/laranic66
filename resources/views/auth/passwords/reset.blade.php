									...
									<div class="kt-login__signin">
										...
										<div class="kt-login__form">
											<form class="kt-form" action="{{ route('password.update') }}" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    <input id="password-confirm" type="password" class="form-control form-control-last" name="password_confirmation" required autocomplete="new-password" placeholder="Re-enter New Password">
                                                </div>
