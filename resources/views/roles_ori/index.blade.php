    ...
    <script>
        $(document).ready(function () {
            ...
            var column = [
                ...
                { field: "role_name",title: "Role Name",filterable: true,width: 110},
                { field: "role_description",title: "Description",filterable: true,width:200},
                { field: "role_status",title: "Status",filterable: true,width:80,textAlign: 'center'},
                { field: "role_lastupdate",title: "Lastupdate",filterable: true,width:200,textAlign: 'center'},
