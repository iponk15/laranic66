            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <input type="text" class="form-control" name="category_code" placeholder="Enter category code" tavindex="1">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <input type="text" class="form-control" name="category_name" placeholder="Enter category name" tavindex="2">
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                            ...
                            <div data-repeater-item class="row kt-margin-b-10">
                                <div class="col-lg-4 col-md-3 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input required type="text" name="subcat_code" class="form-control form-control-danger" placeholder="Sub category code">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-3 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input required type="text" name="subcat_name" class="form-control form-control-danger" placeholder="Sub category name">
                                    </div>
                                </div>
                                <div class="col-lg-2">
