        ...
        <form class="kt-form kt-form--label-right form_add" action="{{ $url . '/store' }}" id="kt_form_1" method="post">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <input type="text" class="form-control" name="venpol_title" placeholder="Enter policy title" tavindex="2">
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8 col-md-3 col-sm-12">
                        <textarea class="form-control" id="venpol_content" name="venpol_content"></textarea>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
            </div>
